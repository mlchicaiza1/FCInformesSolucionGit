...
namespace FCInformesSolucion.Controllers
{
    ...
    public class AgencyController : BaseMaintenanceController<Agency, AgencyModel, AgencyViewModel>
    {
        ...
        protected override IQueryable<Agency> ApplyFilters(IQueryable<Agency> generalQuery, MvcJqGrid.Filter filter)
        {
        ...
        protected override string[] GetRow(Agency entity)
        {
            return new[] {
                entity.Name,                
